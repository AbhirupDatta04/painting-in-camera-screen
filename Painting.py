...
while True:
    ...
    if len(cnts) > 0:
        ...
        # Radius of the enclosing circle around contour
        ((x, y), radius) = cv2.minEnclosingCircle(cnt)
        cv2.circle(frame, (int(x), int(y)), int(radius), (0, 255, 255), 2)
        # moments to calculate the center of the contour (in this case Circle)
        M = cv2.moments(cnt)
    ...
    # lines of colors (Blue, Green, Red and Yellow)
